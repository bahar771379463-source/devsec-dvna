pipeline {  
    ...
    steps {  
        ...
        // 🧾 المرحلة الجديدة: توليد تقرير موحد من Trivy + Snyk
        stage('🧾 Generate Unified Security Report') {
            steps {
                script {
                    echo "📊 Generating unified HTML report from Snyk + Trivy..."
                    ...
                    echo "✅ Unified Security Report Generated Successfully!"
                }
            }
        }
    ...
    post {  
        success {  
            ...
            emailext(  
                ...
                attachmentsPattern: "security-summary.html"  
            )  
